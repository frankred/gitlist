...
class Config {
	...
	public static function fromFile($file) {
		...
		// If attribute in property file is false, then it is interpreted as unset
		// So on next save operation the property is lost
		if (empty($data['app']['debug'])) {
			$data['app']['debug'] = 'false';
		} else {
			$data['app']['debug'] = 'true';
		}
		if (empty($data['app']['cache'])) {
			$data['app']['cache'] = 'false';
		} else {
			$data['app']['cache'] = 'true';
		}
		if (empty($data['app']['public'])) {
			$data['app']['public'] = 'false';
		} else {
			$data['app']['public'] = 'true';
		}
